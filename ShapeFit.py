# -*- coding: utf-8 -*-
"""Copy of lkl_shape_Oct_2024_plots_cut_Katayoon_snd.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1_NwTig9qxVjBbuDbrQtmzgyuwTvLQovs
"""
...
!pip install -v --no-build-isolation classy

!wget https://ftp.rediris.es/mirror/GNU/gsl/gsl-2.8.tar.gz
!tar -xzf gsl-2.8.tar.gz

!cd gsl-2.8; ./configure

!cd gsl-2.8;make -j
!cd gsl-2.8; make install -j

!rm -rf class_ede

!git clone https://github.com/PoulinV/AxiCLASS.git class_ede

with open("class_ede/python/setup.py") as inf:
  with open("class_ede/python/setup.py.2",'w') as ouf:
    for line in inf:
      if "name=" in line:
        line=line.replace('classy','edeclassy')
      if "Extension(" in line:
        line=line.replace('"classy"','"edeclassy"')
      ouf.write(line)

with open("class_ede/Makefile") as inf:
  with open("class_ede/Makefile.2",'w') as ouf:
    for line in inf:
      if "setup.py install" in line:
        line = 	"\tcd python; export CC=$(CC); $(PYTHON) -m pip install . \n"
      ouf.write(line)

!mv class_ede/python/setup.py.2 class_ede/python/setup.py
!mv class_ede/Makefile.2 class_ede/Makefile

!pip install cython==0.29.32
!cd class_ede; make clean; PYTHON=python3 make -j; cd ..

import classy as edeclassy
...
class cosmology_generator:
    ...
    def __init__(self, fiducial_cosmo: dict, cosmology: doct, kmin: float = 2e-5) -> np.ndarray:
        """
    ...
    def derivative_single(self, nowiggle_key: str, processing_key: str, derivative_key: str) \
    ...
    def derivative_all_for(self, nowiggle_key: str, processing_key: str, replace_options: dict = None) \
